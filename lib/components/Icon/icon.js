...
export var Icon = function (props) {
    var _a;
    var type = props.type, style = props.style, className = props.className, state = props.state, children = props.children, onClick = props.onClick, trigger = props.trigger, restProps = __rest(props, ["type", "style", "className", "state", "children", "onClick", "trigger"]);
    var classes = classNames('ararin-icon', className, (_a = {},
        _a["ararin-icon-" + type] = type && (IconRes[type] || IconSpecialRes[type]),
        _a["ararin-icon-" + state] = state,
        _a));
