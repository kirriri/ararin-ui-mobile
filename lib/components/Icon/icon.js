...
export var Icon = function (props) {
    var _a;
    var type = props.type, style = props.style, className = props.className, iconState = props.iconState, children = props.children, onClick = props.onClick, restProps = __rest(props, ["type", "style", "className", "iconState", "children", "onClick"]);
    var classes = classNames('ararin-icon', className, (_a = {},
        _a["ararin-icon-" + type] = type && IconRes[type],
        _a['ararin-icon-spin'] = iconState,
        _a));
