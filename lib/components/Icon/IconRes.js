...
export var IconSpecialRes = {
    'showHide': React.createElement("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink" },
        React.createElement("path", { className: "ararin-icon-showHide-lash-1", d: "M24,64 19,70", fill: "none", strokeLinecap: "round", strokeWidth: "6" }),
        React.createElement("path", { className: "ararin-icon-showHide-lash-2", d: "M50,70 50 78", fill: "none", strokeLinecap: "round", strokeWidth: "6" }),
        React.createElement("path", { className: "ararin-icon-showHide-lash-3", d: "M76,64 81,70", fill: "none", strokeLinecap: "round", strokeWidth: "6" }),
        React.createElement("path", { className: "ararin-icon-showHide-top", fill: "none", strokeLinecap: "round", strokeWidth: "8" }),
        React.createElement("path", { className: "ararin-icon-showHide-bottom", fill: "none", strokeLinecap: "round", strokeWidth: "8", d: "M10,51 Q50,90 90,51" }),
        React.createElement("circle", { className: "ararin-icon-showHide-eye-ball", fill: "none", strokeWidth: "10", cx: "50", cy: "50", r: "15", strokeLinecap: "round", transform: "rotate(90 50 50)" })),
    'loading': React.createElement("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink" },
        React.createElement("circle", { cx: "50", cy: "50", r: "45", strokeWidth: "6", fill: "none", stroke: "#e6e6e6" }),
        React.createElement("circle", { className: "ararin-circle", strokeDashoffset: "330", strokeLinecap: "round", strokeDasharray: "282", cx: "50", cy: "50", r: "45", strokeWidth: "6", fill: "none" }),
        React.createElement("path", { className: "ararin-icon-loading-failed-lineOne", d: "M28 28 L72 72", strokeWidth: "5", fill: "none", strokeLinecap: "round" }),
        React.createElement("path", { className: "ararin-icon-loading-failed-lineTwo", d: "M72 28 L28 72", strokeWidth: "5", fill: "none", strokeLinecap: "round" }),
        React.createElement("polyline", { className: "ararin-icon-loading-success-line", strokeWidth: "5", fill: "none", strokeLinecap: "round", strokeLinejoin: "round", points: "22,53 44,71 76,35" })),
};
