...
export const ScratchCard: FC<ScratchCardProps> = 
            ...
            if(hideImg) {
                ...
                hideImgCtx.onload = () => {
                    ...
                    if (typeof openingImg === 'string') {
                        prizeImg.src = openingImg
                    } else {
                        prizeImg.src = openingImg.props.src
                    }
                    const prizeCanvas = prizeRef.current.getContext("2d")
                    prizeImg.onload = () => {
                        prizeCanvas.beginPath();
                        prizeCanvas.drawImage(prizeImg, 0, 0, offsetWidth, offsetHeight);
